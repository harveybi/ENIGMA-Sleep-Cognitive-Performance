...
echo "executable = /data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/XGBoost/run_XGBoost_SHIP_htcondor.sh" >> $submit_file
echo "" >> $submit_file

# Define common variables
log_dir="/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/XGBoost/condor_logs/SHIP/ml_pipeline_htcondor"
output_dir="/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/XGBoost/condor_outputs/SHIP/ml_pipeline_htcondor"
error_dir="/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/XGBoost/condor_errors/SHIP/ml_pipeline_htcondor"
...
feature_combs=("Sleep" "Cov" "Sleep_Cov" "Sleep_Shuffle_Cov" "Sleep_APOE" "Sleep_APOE_Shuffle" "Sleep_Cov_APOE" "Sleep_Cov_APOE_Shuffle" "Brain" "Sleep_Cov_Brain" "Sleep_Cov_Brain_Shuffle" "Sleep_Cov_Brain_APOE" "Sleep_Cov_Brain_APOE_Shuffle")
