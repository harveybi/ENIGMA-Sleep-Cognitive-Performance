...
echo "request_memory = 16GB" >> $submit_file
echo "request_disk   = 4GB" >> $submit_file
...
echo "executable = /data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/XGBoost/run_SHAP_XGBoost_SHIP_Stroop_NAI.sh" >> $submit_file
echo "" >> $submit_file

# Define common variables
log_dir="/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/XGBoost/condor_logs/SHIP/SHAP"
output_dir="/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/XGBoost/condor_outputs/SHIP/SHAP"
error_dir="/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/XGBoost/condor_errors/SHIP/SHAP"

# Define the list of feature combinations, zscore cases, and targets
feature_combs=("Sleep" "Cov" "Brain" "CT" "SA" "Subcor" "Sleep_Cov" "Sleep_Cov_Brain" "Sleep_Cov_CT" "Sleep_Cov_SA" "Sleep_Cov_Subcor" "Sleep_Brain" "Sleep_CT" "Sleep_SA" "Sleep_Subcor" "Cov_Brain" "Cov_CT" "Cov_SA" "Cov_Subcor" "Sleep_Shuffle_Cov" "Sleep_Cov_Subcor_Shuffle" "Sleep_Shuffle_Cov_Subcor" "Sleep_Shuffle_Subcor" "Cov_Brain_Shuffle" "Cov_Subcor_Shuffle")
