...
results_path = f'/p/project/cinm-7/bi1/ENIGMA_Sleep_Cog_Prediction/Results/CV_AutoGluon/{target}/SHIP_Trend/'
...
# %%
print(f"\nStart getting cross-validation results")
...
print(f"\nCross-validation results completed. Time used: {cv_end_time - cv_start_time}")
...
score_var_Liege, test_mae_Liege, test_rmse_Liege, test_r2_Liege, test_corr_Liege, test_corr_spearman_Liege = ml_pipe_instance.test_perform_plot(df_test_Liege, y_test_Liege, 'Test Set')
