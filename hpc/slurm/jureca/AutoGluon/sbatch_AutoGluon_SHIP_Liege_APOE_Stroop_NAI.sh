...
err_log="logs/SHIP_Liege/errors/${ARG2}_${ARG1}.err"
...
srun --ntasks=1 --cpus-per-task=${SLURM_CPUS_PER_TASK} python3 /p/project/cinm-7/bi1/ENIGMA_Sleep_Cog_Prediction/Code/AutoGluon/AutoGluon_SHIP_Liege_APOE_Stroop_NAI.py "${ARG1}" "${ARG2}" "${SLURM_CPUS_PER_TASK}" >> "/p/project/cinm-7/bi1/ENIGMA_Sleep_Cog_Prediction/Code/AutoGluon/combined_logs/SHIP_Liege/ml_pipeline/${ARG2}_${ARG1}_log.txt" 2>&1