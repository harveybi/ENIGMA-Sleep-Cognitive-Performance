import os
import sys
sys.path.append('/p/project/cinm-7/bi1/ENIGMA_Sleep_Cog_Prediction/Code/lib/')
...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='AutoGluon, SHIP_Trend and Liege dataset.')
...
# %%
data_save_path = '/p/project/cinm-7/bi1/ENIGMA_Sleep_Cog_Prediction/Data/'
# data_save_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Data/'
results_path = f'/p/project/cinm-7/bi1/ENIGMA_Sleep_Cog_Prediction/Results/AutoGluon/{target}/SHIP_Trend_Liege/'
...
df_SHIP[columns_to_object] = df_SHIP[columns_to_object].astype('object')
df_Liege[columns_to_object] = df_Liege[columns_to_object].astype('object')
df_Liege_COF[columns_to_object] = df_Liege_COF[columns_to_object].astype('object')
df_Liege_COGNAP[columns_to_object] = df_Liege_COGNAP[columns_to_object].astype('object')
df_KI[columns_to_object] = df_KI[columns_to_object].astype('object')
...
df_SHIP[columns_to_float] = df_SHIP[columns_to_float].astype('float64')
df_Liege[columns_to_float] = df_Liege[columns_to_float].astype('float64')
df_Liege_COF[columns_to_float] = df_Liege_COF[columns_to_float].astype('float64')
df_Liege_COGNAP[columns_to_float] = df_Liege_COGNAP[columns_to_float].astype('float64')
df_KI[columns_to_float_KI] = df_KI[columns_to_float_KI].astype('float64')

# %%
"""
Concatenate SHIP_Trend and Liege datasets then preprocess the data
"""
...
score_var_Liege_COF, test_mae_Liege_COF, test_rmse_Liege_COF, test_r2_Liege_COF, test_corr_Liege_COF, test_corr_spearman_Liege_COF = ml_pipe_instance.test_perform_plot(df_test_Liege_COF, y_test_Liege_COF, 'Test Set Liege COF')

df_test_Liege_COGNAP = df_Liege_COGNAP_ml
y_test_Liege_COGNAP = df_test_Liege_COGNAP[y].values.reshape(-1)
score_var_Liege_COGNAP, test_mae_Liege_COGNAP, test_rmse_Liege_COGNAP, test_r2_Liege_COGNAP, test_corr_Liege_COGNAP, test_corr_spearman_Liege_COGNAP = ml_pipe_instance.test_perform_plot(df_test_Liege_COGNAP, y_test_Liege_COGNAP, 'Test Set Liege COGNAP')
...
score_var_Liege_COF_COGNAP, test_mae_Liege_COF_COGNAP, test_rmse_Liege_COF_COGNAP, test_r2_Liege_COF_COGNAP, test_corr_Liege_COF_COGNAP, test_corr_spearman_Liege_COF_COGNAP = ml_pipe_instance.test_perform_plot(df_test_Liege_COF_COGNAP, y_test_Liege_COF_COGNAP, 'Test Set Liege COF COGNAP')

if target == 'Memory':
    df_test_KI = df_KI_ml
    y_test_KI = df_test_KI[y].values.reshape(-1)
    score_var_KI, test_mae_KI, test_rmse_KI, test_r2_KI, test_corr_KI, test_corr_spearman_KI = ml_pipe_instance.test_perform_plot(df_test_KI, y_test_KI, 'Test Set KI')
    ...
    print(f"Average CV Test R2 Liege COF: {score_var_Liege_COF}")
    print(f"Average CV Test R2 Liege COGNAP: {score_var_Liege_COGNAP}")
    print(f"Average CV Test R2 Liege COF_COGNAP: {score_var_Liege_COF_COGNAP}")
    print(f"Average CV Test R2 KI: {score_var_KI}")
