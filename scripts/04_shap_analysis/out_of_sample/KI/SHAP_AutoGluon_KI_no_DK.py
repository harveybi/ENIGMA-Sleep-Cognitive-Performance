...
# save the explainer
with open(SHAP_path + 'explainer_train_set_KI.pkl', 'wb') as f:
...
explanation_train_set_test_KI = explainer_train_set(df_test[X], max_evals=2000)
with open(SHAP_path + 'explanation_train_set_test_KI.pkl', 'wb') as f:
