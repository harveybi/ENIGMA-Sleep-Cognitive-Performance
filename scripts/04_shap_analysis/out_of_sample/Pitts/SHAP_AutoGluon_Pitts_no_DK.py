...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='SHAP for AutoGluon, Pitts dataset.')
...
# save the explainer
with open(SHAP_path + 'explainer_train_set_Pitts.pkl', 'wb') as f:
...
explanation_train_set_test_Pitts = explainer_train_set(df_test[X], max_evals=2000)
with open(SHAP_path + 'explanation_train_set_test_Pitts.pkl', 'wb') as f:
    pickle.dump(explanation_train_set_test_Pitts, f)
