...
def run_script(script_path, feature, target, log_file):
    with open(log_file, 'a') as log:  # Open the log file in append mode
        cmd = ["python3", script_path, feature, target]
...
def main():
    ...
    script_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/Pitts/AutoGluon_Pitts_validate.py'  # Update the path to your script
    log_dir = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/combined_logs/Pitts/AutoGluon'  # Update the path to your log directory
    ...
    targets = ['Executive', 'Memory_Letter', 'Memory_Spatial', 'Executive_rgo_age', 'Memory_Letter_rgo_age', 'Memory_Spatial_rgo_age']
    ...
    for feature in feature_combines:
        for target in targets:
            ...
            # Run the script
            run_script(script_path, feature, target, log_file)
