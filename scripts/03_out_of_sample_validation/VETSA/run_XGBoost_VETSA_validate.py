...
def main():
    ...
    script_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/VETSA/XGBoost_VETSA_validate.py'  # Update the path to your script
    log_dir = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/combined_logs/VETSA/XGBoost'  # Update the path to your log directory
