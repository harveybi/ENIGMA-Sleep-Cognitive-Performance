...
def main():
    ...
    script_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/VETSA/AutoGluon_VETSA_validate.py'  # Update the path to your script
    log_dir = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/combined_logs/VETSA/AutoGluon'  # Update the path to your log directory
    ...
    targets = ['Stroop', 'Memory_Digit', 'Memory_Letter', 'Stroop_rgo_age', 'Memory_Digit_rgo_age', 'Memory_Letter_rgo_age']
