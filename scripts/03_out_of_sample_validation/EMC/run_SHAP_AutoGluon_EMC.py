...
def main():
    ...
    script_path = r'C:\path\to\SHAP_AutoGluon_EMC.py'  # Update the path to your script
    ...
    feature_combines = ['Sleep_Cov'] # another is 'Sleep_Cov_Brain', please run 'Sleep_Cov' first, as 'Sleep_Cov_Brain' very time consuming.
    targets = ['Stroop']
