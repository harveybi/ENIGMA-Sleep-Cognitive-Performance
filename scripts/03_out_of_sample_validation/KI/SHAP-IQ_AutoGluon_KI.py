...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='SHAP-IQ for AutoGluon, KI dataset.')
...
with parallel_config(
        ...
        request_disk="1GB",
        request_memory="2Gb",
        shared_data_dir="/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/joblib_htcondor/KI",
        throttle=[20],
...
with open(shapiq_path + 'ivs_SHIP_KI.pkl', 'wb') as f:
    pickle.dump(ivs, f)

print("\nNote, the SHAP-IQ value based on SHIP-Trend to KI is saved, but no plots were generated.\n")
