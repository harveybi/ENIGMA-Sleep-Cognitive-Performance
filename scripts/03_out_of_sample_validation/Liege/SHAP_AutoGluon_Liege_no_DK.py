...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='SHAP for AutoGluon, Liege dataset.')
...
# save the masker
with open(case_results_path + 'masker.pkl', 'wb') as f:
...
#
# # save the explainer
# with open(SHAP_path + 'explainer_train_set_Liege.pkl', 'wb') as f:
...
# explanation_train_set_test_Liege = explainer_train_set(df_test[X], max_evals=2000)
# with open(SHAP_path + 'explanation_train_set_test_Liege.pkl', 'wb') as f:
