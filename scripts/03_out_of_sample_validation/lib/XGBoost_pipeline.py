...
class AdMLPipeline:
    ...
    def xgboost_cross_val_iteration(self, repeat_fold, train_index, test_index):
        ...
        with joblib.parallel_backend(backend="dask", wait_for_workers_timeout=2 ** 30):
            ...
            study.optimize(lambda trial: self.xgboost_objective(trial, X_train, y_train), n_trials=150)  # n_trials=100, n_jobs=self.num_cores
            best_params = study.best_params
    ...
    def test_perform_plot(self, df_test, X_train_preprocessor=None, age_poly=None, age_lr=None,fig_title=None, scatter_color=None):
        ...
        # Add legend text in top-right corner
