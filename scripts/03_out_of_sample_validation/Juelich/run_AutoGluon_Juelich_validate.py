...
def main():
    ...
    script_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/Juelich/AutoGluon_Juelich_validate.py'  # Update the path to your script
    log_dir = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Code/Out-of-sample_validation/combined_logs/Juelich/AutoGluon'  # Update the path to your log directory
