...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='SHAP for AutoGluon, Juelich dataset.')
...
# save the explainer
with open(SHAP_path + 'explainer_train_set_Juelich_' + sess + '.pkl', 'wb') as f:
...
explanation_train_set_test_Juelich = explainer_train_set(df_test[X], max_evals=2000)
with open(SHAP_path + 'explanation_train_set_test_Juelich_' + sess + '.pkl', 'wb') as f:
    pickle.dump(explanation_train_set_test_Juelich, f)
