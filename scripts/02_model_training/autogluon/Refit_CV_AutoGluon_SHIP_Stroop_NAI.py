...
for i, row in leaderboard_minimal.iterrows():
    ...
    new_hyperparameters[model_name] = {
        ...
        'ag_args_fit': model_ag_args_fit,
        'child_hyperparameters': model_child_hyperparameters,
        'child_ag_args_fit': model_child_ag_args_fit,
...
ml_pipe_instance = AdMLPipeline(X, y, df_train, save_path=case_results_path, model=model)

print(f"\nStart CV resulting")
scores = ml_pipe_instance.run_fake_autogluon_cross_val_iteration(stratified_label='Group_Age_SEX')
...
# %%
# TODO: change to used loaded model to get test results
