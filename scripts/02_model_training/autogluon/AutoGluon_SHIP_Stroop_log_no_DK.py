...
import AutoGluon_pipeline_log
from AutoGluon_pipeline_log import AdMLPipeline
...
should_log = (target == 'Stroop')
ml_pipe_instance = AdMLPipeline(
    X,
    y,
    df_train,
    num_cores,
