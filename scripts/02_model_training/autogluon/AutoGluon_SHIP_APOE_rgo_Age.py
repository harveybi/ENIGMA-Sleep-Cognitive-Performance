...
print(f"\nStarting AutoGlon pipeline for {target} prediction with feature combination {feature_comb}.\n")
start_time = datetime.now()

# %%
data_save_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Data/'
results_path = f'/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Results/AutoGluon/{target}/SHIP_Trend_Liege/'
...
with joblib.parallel_backend(backend="dask", wait_for_workers_timeout=2 ** 30):
    ...
    model = ml_pipe_instance.autogluon_pipe(stratified_label='Group_Age_SEX')
...
score_var_Liege_COF, test_mae_Liege_COF, test_rmse_Liege_COF, test_r2_Liege_COF, test_corr_Liege_COF, test_corr_spearman_Liege_COF = ml_pipe_instance.test_perform_plot(df_test_Liege_COF, 'Test Set Liege COF')

df_test_Liege_COGNAP = df_Liege_COGNAP_ml
score_var_Liege_COGNAP, test_mae_Liege_COGNAP, test_rmse_Liege_COGNAP, test_r2_Liege_COGNAP, test_corr_Liege_COGNAP, test_corr_spearman_Liege_COGNAP = ml_pipe_instance.test_perform_plot(df_test_Liege_COGNAP, 'Test Set Liege COGNAP')

df_test_Liege_COF_COGNAP = pd.concat([df_test_Liege_COF, df_test_Liege_COGNAP], ignore_index=True)
score_var_Liege_COF_COGNAP, test_mae_Liege_COF_COGNAP, test_rmse_Liege_COF_COGNAP, test_r2_Liege_COF_COGNAP, test_corr_Liege_COF_COGNAP, test_corr_spearman_Liege_COF_COGNAP = ml_pipe_instance.test_perform_plot(df_test_Liege_COF_COGNAP, 'Test Set Liege COF COGNAP')
