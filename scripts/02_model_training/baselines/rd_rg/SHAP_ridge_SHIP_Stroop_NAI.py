...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='SHAP for Linear Regression, SHIP_Trend dataset.')
...
print(f"\nStarting SHAP for Linear Regression pipeline for {target} prediction with feature combination {feature_comb}.\n")

# %%
data_save_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Data/'
results_path = f'/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Results/Ridge/{target}/SHIP_Trend/'
