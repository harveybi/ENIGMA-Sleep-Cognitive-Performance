...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='SHAP for SVM-rbf, SHIP_Trend dataset.')
...
print(f"\nStarting SHAP for SVM-rbf pipeline for {target} prediction with feature combination {feature_comb}.\n")
...
# %%
print(f"\nDone! SHAP SVM-rbf pipeline for {target} prediction by {feature_comb} completed successfully.")
