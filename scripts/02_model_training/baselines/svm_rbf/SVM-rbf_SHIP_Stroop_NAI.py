...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='SVM-rbf, SHIP_Trend dataset.')
...
print(f"\nStarting SVM-rbf pipeline for {target} prediction with feature combination {feature_comb}.\n")

# %%
data_save_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Data/'
results_path = f'/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Results/SVM-rbf/{target}/SHIP_Trend/'
...
# %%
print(f"\nDone! SVM-rbf pipeline for {target} prediction by {feature_comb} completed successfully.")
# print Date and Time
