...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='SVM-rbf Regression for n-back working memory in Liege dataset.')
...
print(f"\nStarting SVM-rbf regression pipeline for {target} prediction with feature combination {feature_comb}.\n")

# %%
data_save_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Data/'
results_path = f'/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Results/SVM-rbf/{target}/Liege/'
...
scores, model = ml_pipe_instance.svm_rbf_pipe(stratified_label='Group_Age_SEX')
...
# %%
print(f"\nDone! SVM-rbf regression pipeline for {target} prediction by {feature_comb} completed successfully.")
# print Date and Time
