...
# %%
# Argument parsing
parser = argparse.ArgumentParser(description='Linear Regression, SHIP_Trend dataset.')
...
print(f"\nStarting Linear regression pipeline for {target} prediction with feature combination {feature_comb}.\n")

# %%
data_save_path = '/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Data/'
results_path = f'/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Results/Linear/{target}/SHIP_Trend/'
...
scores, model = ml_pipe_instance.linear_rg_pipe(stratified_label='Group_Age_SEX')
...
# %%
print(f"\nDone! Linear regression pipeline for {target} prediction by {feature_comb} completed successfully.")
# print Date and Time
