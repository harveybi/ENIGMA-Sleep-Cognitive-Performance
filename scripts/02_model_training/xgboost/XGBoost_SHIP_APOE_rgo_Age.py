...
results_path = f'/data/project/sleep_ENIGMA_Cognition/Codes/ENIGMA_Sleep_Cognitive/Results/XGBoost/{target}/SHIP_Trend_test/'
...
# %%
# concatenate SHIP_Trend and Liege datasets
df_SHIP_Liege = pd.concat([df_SHIP_ml, df_Liege_ml], ignore_index=True)
# remove 'Age_Group' and 'Group_Age_SEX' columns
df_SHIP_Liege = df_SHIP_Liege.drop(columns=['Age_Group', 'Group_Age_SEX'])

# add a column of 'Age_Group' after 'Age_at_Scan'.
df_SHIP_Liege_ml = utils.add_age_groups(df_SHIP_Liege)
# add a column of Group which represents the group of age groups and SEX groups
df_SHIP_Liege_ml = utils.add_groups_age_sex(df_SHIP_Liege_ml)
...
df_SHIP_Liege_ml[columns_to_object] = df_SHIP_Liege_ml[columns_to_object].astype('category')
...
df_SHIP_Liege_ml[columns_to_float] = df_SHIP_Liege_ml[columns_to_float].astype('float64')
...
#
# end_dask = time.time()
# print(f"Time taken for Dask: {end_dask - start_dask:.2f} seconds")

ml_pipe_instance = AdMLPipeline(X, y, df_train=df_train, num_cores=num_cores, save_path=case_results_path, htcondorcluster=htcondor_cluster)
scores, model = ml_pipe_instance.xgboost_pipe(stratified_label='Group_Age_SEX')
...
# test_mae_Liege, test_rmse_Liege, test_r2_Liege, test_corr_Liege, test_corr_spearman_Liege = ml_pipe_instance.test_perform_plot(df_test_Liege, X_train_preprocessor=whole_X_train_preprocessor, fig_title='Test Set Liege')
test_mae_Liege, test_rmse_Liege, test_r2_Liege, test_corr_Liege, test_corr_spearman_Liege = ml_pipe_instance.test_perform_plot(df_test_Liege, fig_title='Test Set Liege')

df_test_Liege_COF = df_Liege_COF_ml
# test_mae_Liege_COF, test_rmse_Liege_COF, test_r2_Liege_COF, test_corr_Liege_COF, test_corr_spearman_Liege_COF = ml_pipe_instance.test_perform_plot(df_test_Liege_COF, X_train_preprocessor=whole_X_train_preprocessor, fig_title='Test Set Liege COF')
test_mae_Liege_COF, test_rmse_Liege_COF, test_r2_Liege_COF, test_corr_Liege_COF, test_corr_spearman_Liege_COF = ml_pipe_instance.test_perform_plot(df_test_Liege_COF, fig_title='Test Set Liege COF')

df_test_Liege_COGNAP = df_Liege_COGNAP_ml
# test_mae_Liege_COGNAP, test_rmse_Liege_COGNAP, test_r2_Liege_COGNAP, test_corr_Liege_COGNAP, test_corr_spearman_Liege_COGNAP = ml_pipe_instance.test_perform_plot(df_test_Liege_COGNAP, X_train_preprocessor=whole_X_train_preprocessor, fig_title='Test Set Liege COGNAP')
test_mae_Liege_COGNAP, test_rmse_Liege_COGNAP, test_r2_Liege_COGNAP, test_corr_Liege_COGNAP, test_corr_spearman_Liege_COGNAP = ml_pipe_instance.test_perform_plot(df_test_Liege_COGNAP, fig_title='Test Set Liege COGNAP')

df_test_Liege_COF_COGNAP = pd.concat([df_test_Liege_COF, df_test_Liege_COGNAP], ignore_index=True)
# test_mae_Liege_COF_COGNAP, test_rmse_Liege_COF_COGNAP, test_r2_Liege_COF_COGNAP, test_corr_Liege_COF_COGNAP, test_corr_spearman_Liege_COF_COGNAP = ml_pipe_instance.test_perform_plot(df_test_Liege_COF_COGNAP, X_train_preprocessor=whole_X_train_preprocessor, fig_title='Test Set Liege COF COGNAP')
test_mae_Liege_COF_COGNAP, test_rmse_Liege_COF_COGNAP, test_r2_Liege_COF_COGNAP, test_corr_Liege_COF_COGNAP, test_corr_spearman_Liege_COF_COGNAP = ml_pipe_instance.test_perform_plot(df_test_Liege_COF_COGNAP, fig_title='Test Set Liege COF COGNAP')


if 'Memory' in target or 'Memory_rgo_age' in target:
    df_test_KI = df_KI_ml
    test_mae_KI, test_rmse_KI, test_r2_KI, test_corr_KI, test_corr_spearman_KI = ml_pipe_instance.test_perform_plot(df_test_KI, fig_title='Test Set KI')
