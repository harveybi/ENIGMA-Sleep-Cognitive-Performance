...
class AdMLPipeline:
    ...
    def xgboost_cross_val_iteration(self, repeat_fold, train_index, test_index):
        ...
        study.optimize(lambda trial: self.xgboost_objective(trial, X_train, y_train), n_trials=200)  # n_trials=50
    ...
    def xgboost_pipe(self, stratified_label=None):
        ...
        final_best_model = xgb.XGBRegressor(**overall_best_params, random_state=42, n_jobs=self.num_cores, enable_categorical=True)
